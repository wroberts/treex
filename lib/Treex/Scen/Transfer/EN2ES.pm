...
sub get_scenario_string {
    ...
    "T2T::TrFAddVariantsInterpol model_dir=$TM_DIR models='
      static 1.0 enesg-indomain-theta0.3-uuenc_formeme.static.gz
      maxent 0.5 enesg-indomain-theta0.3-uuenc_formeme.maxent.gz
      $IT_FORMEME_MODELS'",
    "T2T::TrLAddVariantsInterpol model_dir=$TM_DIR models='
      static 0.5 enesg-indomain-theta0.3-uuenc_tlemma.static.gz
      maxent 1.0 enesg-indomain-theta0.3-uuenc_tlemma.maxent.gz
      $IT_LEMMA_MODELS'",
